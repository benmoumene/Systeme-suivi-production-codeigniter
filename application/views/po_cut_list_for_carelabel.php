                    ...
                    <div class="form-group">
                        <select required class="form-control" id="po_no" name="po_no" onchange="getReportByPo(id);">
                            ...
                            foreach ($purchase_order_nos as $pos){ ?>
                                <option value="<?php echo $pos['so_no'].'_'.$pos['po_no'].'_'.$pos['purchase_order'].'_'.$pos['item'].'_'.$pos['color'].'_'.$pos['ex_factory_date'];?>"><?php echo $pos['po_no'].'_'.$pos['so_no'].'_'.$pos['purchase_order'].'_'.$pos['item'].'_'.$pos['quality'].'_'.$pos['color'].'_'.$pos['ex_factory_date'];?></option>
                                <?php
                            }
...
//        $("#loader").css("display", "block");
        ...
        $.ajax({
            url: "<?php echo base_url();?>access/getCuttingInfo/",
            type: "POST",
