...
<div id="page">
    ...
    <?php foreach($defect_codes AS $d){

            $defect_code_res = $this->method_call->getDefectCodeInfo($d);

            $defect_name = $defect_code_res[0]['defect_name'];

    ?>

        <div id="result" class="label" >
            <p style="text-align: center; font-size: 16px;"><b><?php echo $defect_name;?></p>
            <center>
                <?php
