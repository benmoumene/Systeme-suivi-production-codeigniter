...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        ...
        <a href="<?php echo base_url();?>access/collar_cuff_send_to_production" id="bundle_scan_tab" class="btn btn-success">Bundle Scan</a>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">INPUT TO SEW</li>
        </ol>
    </div>
</div>
<div class="container clear_both padding_fix">
    ...
    <div class="row">
        ...
        <div class="col-md-1">
            <input type="text" class="form-control" name="bundle_tracking_no" autofocus id="bundle_tracking_no" onkeyup="" />
            <br />
            <div class="col-md-1" id="loader" style="display: none;"><div class="loader"></div></div>
            <br />
            <br />
<!--            <span style="margin-top: 30px;" id="refresh_report" class="btn btn-success" onclick="getPackageSentToSewReport();">Report</span>-->
        </div>
<!--        <div class="col-md-4">-->
...
<!--        </div>-->
        ...
        <div class="col-md-2" style="margin-left: 150px;">
            <button id="submit_btn" class="btn btn-lg btn-success" onclick="sendingPackgeToProduction();">Save</button>
        </div>
...
<script type="text/javascript">
    ...
    function sendingPackgeToProduction() {

//        console.log(bundle_array);
        $("#loader").css("display", "block");
        var line_id = $("#line_no").val();
        var b_track_no = $("#bundle_tracking_no").val();

        var split_bundle_no = b_track_no.split('_');
        var po_no = split_bundle_no[0];
        var cut_no = split_bundle_no[1];
        if(line_id != '') {
            $.ajax({
                url: "<?php echo base_url();?>access/sendingPackageToProduction/",
                type: "POST",
                data: {po_no: po_no, cut_no: cut_no, line_id: line_id},
                dataType: "html",
                success: function (data) {
                    ...
                    {
                        alert("Package Not Completed Yet!");
...
//        alert("Cuff "+po_no+' '+purchase_order+' '+item+' '+quality+' '+color+' '+size);
    ...
    function getPackageSentToSewReport() {
        var line_id = $("#line_no").val();
...
//            }, 15000);
            ...
            $.ajax({
                url: "<?php echo base_url();?>access/getPackageSentToSewReport/",
                type: "POST",
