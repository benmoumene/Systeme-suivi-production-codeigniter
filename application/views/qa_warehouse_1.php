                            ...
                            <div class="table-responsive">
                                <table class="display table table-bordered table-striped" id="">
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone center" rowspan="2"><span data-toggle="tooltip" title="Balance Qty">BQ</span></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="hidden-phone center"><span data-toggle="tooltip" title="Warehouse Production Sample">WPS</span></th>
                                        <th class="hidden-phone center"><span data-toggle="tooltip" title="Warehouse Factory">WF</span></th>
                                        <th class="hidden-phone center"><span data-toggle="tooltip" title="Warehouse Buyer">WB</span></th>
                                        <th class="hidden-phone center"><span data-toggle="tooltip" title="Warehouse Trash">WT</span></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="hidden-phone center">
                                                    <a target="_blank" href="<?php echo base_url(); ?>access/remainQtyStatus/<?php echo $v['po_no']; ?>/<?php echo $v['purchase_order']; ?>/<?php echo $v['item']; ?>/4"><?php echo $v['total_cut_qty'] - $total_finishing_qa; ?></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
