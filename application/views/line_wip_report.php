...
//            window.open("<?php //echo base_url();?>//access/lineWIPDetailReport/"+ element +"/<?php //echo $date ; ?>//","mywindow","menubar=1,resizable=1,width=800,height=400,left=40,top=90,location=yes");
        });
    }
</script>