<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Cutting Target</h1>
        <h2 class="">Cutting Target Assign...</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">Cutting Target Assign</li>
        </ol>
    </div>
</div>
<form action="<?php echo base_url();?>access/assignCuttingTarget" method="post">
<div class="row">
    <div class="col-md-12">
        <div class="block-web">
            <div class="header">
