...
foreach ($bundle_body_list as $row){
...
<div id="page">
    <br />
        <div id="result" style="margin-top: 20px; margin-bottom: -10px; width: 130px; height: auto;">
            <p style="text-align: center; font-size: 15px;"><b>BUNDLE TICKET</b> Front_R</p>
<!--            <p style="margin-bottom: -5px; font-size: 10.5px;"><b>SAP_Cut_PO_Item_S-Grp_B</b></p>-->

            <p style="margin-bottom: -5px; font-size: 10.5px;"><?php if(isset($bundle_tracking_no)){ $bundle_tracking_no=$bundle_tracking_no."bdy."; echo $bundle_tracking_no; } ?></p>
