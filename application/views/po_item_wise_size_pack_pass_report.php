<table class="table">
    ...
    foreach ($order_size as $v){ ?>
        <tr style="<?php if($v['total_cut_input_qty'] > $v['po_item_size_wise_packing_qty']){ ?>background-color: #ff9098; <?php } if($v['total_cut_input_qty'] == $v['po_item_size_wise_packing_qty']){ ?>background-color: #aeff82;<?php } ?>">
