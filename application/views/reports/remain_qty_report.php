                    ...
                    <div class="panel-body">
                        ...
                        <table class="display table table-bordered table-striped" id="dynamic-table" style="font-size: 23px;">
                            ...
                            foreach ($remain_detail as $v){
								...
								$washing_status = $v['washing_status'];
								$packing_status = $v['packing_status'];
...
//                                                }
                                            elseif(($access_points==4) && ($access_points_status==4) && ($washing_status == 1) && ($packing_status == 0)){
                                                echo 'Washed';
                                            }
											elseif(($access_points==4) && ($access_points_status==4) && ($washing_status == 0) && ($packing_status == 0)){
                                                echo 'End Pass';
                                            }
