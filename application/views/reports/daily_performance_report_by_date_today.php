<table class="display table table-bordered table-striped" id="">
    ...
    <tbody>
        <tr style="background-color: #f7ffb0;">
            ...
            <th class="center"><?php echo $cutting_normal_prod[0]['normal_hour_cutting_output'];?></th>
            <th class="center"><?php echo ($cutting_prod[0]['total_cutting_output'] - $cutting_normal_prod[0]['normal_hour_cutting_output']);?></th>
            <th class="center"><a target="_blank" class="btn btn-warning" href="<?php echo base_url();?>dashboard/getDailyCuttingReportDetail/<?php echo $search_date;?>"><?php echo $cutting_prod[0]['total_cutting_output'];?></a></th>
        </tr>
    </tbody>
</table>
...
<table class="display table table-bordered table-striped" id="">
    ...
    <tr>
        ...
        <td class="center"><?php echo $f['finishing_normal_hours_output'];?></td>
        <td class="center"><?php echo $over_time_finish_qty;?></td>
        <td class="center"><?php echo $f['total_finishing_output'];?></td>
    </tr>
    <?php } ?>
    </tbody>
</table>