...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Wash Send Report</h1>
        <h2 class="">Wash Send Report by Date...</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">Wash Send Report</li>
        </ol>
    </div>
</div>
                ...
                <div class="porlets-content">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-primary" id="submit_btn" onclick="getDateWiseWashSendReport();">Search</button>
                            </div>
...
<script type="text/javascript">
    ...
    function getDateWiseWashSendReport() {
        ...
        if(from_date != ''){
            ...
            $.ajax({
                url: "<?php echo base_url();?>dashboard/getDateWiseWashSendReport/",
                type: "POST",
