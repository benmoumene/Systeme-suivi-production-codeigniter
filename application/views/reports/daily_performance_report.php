...
<!--                <h3 class="content-header">Daily Performance Report</h3>-->
        ...
        <div id="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="search_date" name="search_date" />
    ...
    function getDailySummaryReport(){
        ...
        if(search_date != '' && search_date != 'undefined--undefined'){
            ...
            if(search_date == today_date){
                ...
                $.ajax({
                    url: "<?php echo base_url();?>dashboard/getDailySummaryReportByDateToday/",
                    type: "POST",
                    data: {date: search_date},
                    dataType: "html",
                    success: function (data) {
