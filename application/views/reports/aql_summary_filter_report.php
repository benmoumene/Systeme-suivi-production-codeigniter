        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="hidden-phone center"><?php echo $today_planned_po;?></td>
                    <td class="hidden-phone center"><?php echo $today_offered_po;?></td>
                    <td class="hidden-phone center"><?php echo $today_passed_po;?></td>
                    <td class="hidden-phone center"><?php echo $today_failed_po;?></td>
                    <td class="hidden-phone center"><?php echo $today_plan_vs_balance;?></td>
                    <td class="hidden-phone center"><?php echo $total_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_ready_for_aql_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_offered_aql_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_passed_aql_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_failed_aql_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_po-$total_offered_aql_po;?></td>
                    <td class="hidden-phone center"><?php echo $total_po-$total_ready_for_aql_po;?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
