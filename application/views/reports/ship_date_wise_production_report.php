                ...
                <div class="porlets-content">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-primary" id="submit_btn" onclick="getShipDateWiseDailyProductionReport();">Search</button>
                            </div>
...
<script type="text/javascript">
    ...
    function getShipDateWiseDailyProductionReport() {
        var brands = $("#brands").val();
        ...
        if(ship_date != '' && brands != null && po_type != ''){
            ...
            $.ajax({
                url: "<?php echo base_url();?>dashboard/getShipDateWiseDailyReport/",
                type: "POST",
