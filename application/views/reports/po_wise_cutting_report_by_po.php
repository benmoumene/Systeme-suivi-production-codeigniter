            ...
            <div class="panel-body">
                ...
                <table class="table">
                    ...
                    <?php foreach ($cut_order as $v_1){ ?>
                        <tr style="<?php if($v_1['total_cut_qty'] > $v_1['count_scanned_pc']){ ?>background-color: #ff9098; <?php } if($v_1['total_cut_qty'] <= $v_1['count_scanned_pc']){ ?>background-color: #aeff82;<?php } ?>">
