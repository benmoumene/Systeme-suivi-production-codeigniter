        ...
        <div class="contentpanel">
            <div class="pull-left breadcrumb_admin clear_both">
                <div class="pull-left page_title theme_color">
                    <h1>Line Wise Pass Report</h1>
                    <h2 class="">Line Wise Pass Report...</h2>
                </div>
                <div class="pull-right">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url();?>">Home</a></li>
                        <li class="active">Line Wise Pass Report</li>
                    </ol>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function drawBasic() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Lines', 'WIP Qty', { role: 'annotation'}, 'Today Input Qty', { role: 'annotation'}, 'Mid QC Pass', { role: 'annotation'}, 'End QC Pass', { role: 'annotation'}],
            ...
            foreach ($line_report as $v)
            {
                ...
                echo "['$line_name',$count_qty_line,'$count_qty_line',$count_input_qty_line,'$count_input_qty_line',$count_mid_pass_qty,'$count_mid_pass_qty',$count_end_line_qc_pass,'$count_end_line_qc_pass'],";
            }
            ?>
        ]);

        var options = {
            title: "Line Wise Report of <?php echo $date;?>",
            bars: 'vertical', // Required for Material Bar Charts.
            colors: ['#fcb441', '#2baaef', '#4063fc', '#50ba30'],
            theme: 'material',
            vAxis: {
                title: 'Quantity'
            },
...
//            window.open("<?php //echo base_url();?>//access/linePassDetailReport/"+ element +"/<?php //echo $date ; ?>//","mywindow","menubar=1,resizable=1,width=800,height=400,left=40,top=90,location=yes");
        });
    }
</script>