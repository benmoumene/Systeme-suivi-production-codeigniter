        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <div class="col-md-3">
                  <input id="cl_no" onblur="getClDetail();">
              </div>
<!--              <div class="col-md-3">-->
...
<!--                            <td>-->
<!--                                <a target="_blank" class="btn btn-primary" href="--><?php //echo base_url();?><!--bcps/single_generated_care_label_printing.php?pc_tracking_no=--><?php //echo $v['pc_tracking_no'];?><!--">Print Care Label</a>-->
<!--                            </td>-->
<!--                        </tr>-->
<!--                    --><?php //} ?>
                  </tbody>
