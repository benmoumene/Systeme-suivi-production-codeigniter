                ...
                <div class="col-md-12">
                    <section class="panel default blue_title h2">
                        <div class="panel-body">
                            ...
                            &nbsp;
                            <a href="" target="_blank" name="defect_btn" id="defect_btn" class="btn btn-warning btn-lg">Defects</a>
                            &nbsp;
                            <a href="" target="_blank" name="reject_btn" id="reject_btn" class="btn btn-danger btn-lg">Reject</a>
                        </div>
                    </section>
                <!--/col-md-6-->
            </div>
...
//                $.ajax({
//                    type: "POST",
//                    url: "<?php //echo base_url();?>//access/care_label_mid_line_qc/",
...
//                $.ajax({
//                    type: "POST",
//                    url: "<?php //echo base_url();?>//access/care_label_mid_line_qc_defect/",
//                    data: {care_label_no: care_label_no, access_points_status: status},
//                    dataType: "html",
//                    success: function (data) {
//                        $("#message").empty();
...
//                $.ajax({
//                    type: "POST",
//                    url: "<?php //echo base_url();?>//access/care_label_mid_line_qc_reject/",
//                    data: {care_label_no: care_label_no, access_points_status: status},
//                    dataType: "html",
//                    success: function (data) {
//                        $("#message").empty();
