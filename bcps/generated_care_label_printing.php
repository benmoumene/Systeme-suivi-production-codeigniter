...
<div id="page">
    <div id="result" style="margin-top: 0px;margin-left: 0px; width: auto; height: auto;">
        ...
        <table border="0" style="font-size: 9px !important;">
            <tr>
            ...
            <tr>
                <td style="font-size: 9px;"><?php echo $pc_tracking_no;?></td>
            </tr>
            <?php
            if($brand == 'BOSS') {
                ?>
                <tr>
                    <td style="font-size: 9px;">B PO: <?php echo $purchase_order . '-' . $item; ?></td>
                </tr>
                <?php
            }else {
                ?>
                <tr>
                    <td style="font-size: 9px;">B PO: <?php echo $purchase_order; ?></td>
                </tr>
                <?php
            }
            ?>
            ...
            <tr>
                <td style="font-size: 9px;"><?php echo $bundle_tracking_no;?></td>
            </tr>
            <tr>
                <td style="font-size: 9px;">Quality: <?php echo $quality.'-'.$color;?></td>
            </tr>
            <tr>
                <td style="font-size: 9px;">Style No: <?php echo $style_no.'-'.substr($brand, 0, 1);?></td>
            </tr>
            <tr>
                <td style="font-size: 9px;">Style Name: <?php echo $style_name;?></td>
            </tr>
            <tr>
                <td align="left">
                    <span style="text-align: left; font-size: 9px;">Size: <?php echo $size;?></span>
                </td>
            </tr>
            <tr>
                <td style="float: left; margin-left: 25px;">
                    <?php
                    $code = '<center><img src="https://chart.googleapis.com/chart?chs=58x58&cht=qr&chl='.$pc_tracking_no.'" title="QR Code Image!"></center>';
                    echo $code;
                    ?>
                </td>
            </tr>
            ...
            <tr>
                <td style="font-size: 60px;"><b style="margin-left: 35px;">+</b></td>
            </tr>
            <tr>
                <td style="font-size: 9px;"><?php echo $pc_tracking_no;?></td>
            </tr>
            <tr>
                <td style="font-size: 9px;">ST_PO_Item_Clr_Cut_S-Lay_B</td>
            </tr>
            <tr>
                <td style="font-size: 9px;"><?php echo $bundle_tracking_no;?></td>
            </tr>
