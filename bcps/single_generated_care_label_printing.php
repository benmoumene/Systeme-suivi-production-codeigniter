...
$pc_tracking_no = $_GET['pc_tracking_no'];
...
<?php
$sl = 0;
$SQL_1="SELECT * FROM efl_db_pts.`tb_care_labels` WHERE pc_tracking_no='$pc_tracking_no'";    //table name
...
<div id="page">
    <div id="result" style="margin-top: 0px;margin-left: 0px; width: auto; height: auto;">
        ...
        <table border="0" style="font-size: 9px;">
            ...
            <tr>
                <td>Quality: <?php echo $quality.'-'.$color;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>ST_PO_Item_Clr_Cut_S-Lay_B</td>
            </tr>
            <tr>
                <td><?php echo $bundle_tracking_no;?></td>
            </tr>
